					...
					<div class="card-body p-0">
						...
						<div class="p-3">
							...
							<!-- 	<div class="info" id="info__birth">
								...
								<div class=" mb-3">
									<input id="exaddress1" class="asdf form-control-user form-control" type="text" placeholder="주소를 입력해주세요" name="address1" /> <input type="button" class="addbtn" value="주소찾기">
								</div>
								<div class=" mb-3">
									<input id="exaddress2" class="form-control form-control-user" type="text" placeholder="상세주소" name="postNo" />
								</div>

								<div class=" mb-3">
									<input id="exaddress3" class="form-control form-control-user" type="text" placeholder="상세주소" name="address2" />
								</div>
