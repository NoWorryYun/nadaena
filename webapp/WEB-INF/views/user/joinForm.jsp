				...
				<div class="">
					...
					<div class="hobby-check">
						...
						<ul class="">
							...
							<li class="cata"><input type="checkbox" id="cbcheck9" name='interestName' value="요리"/> <label for="cbcheck9"><p class="istp">요리</p> <img src="${pageContext.request.contextPath}/assets/img/interest/요리.jpg" /></label></li>
