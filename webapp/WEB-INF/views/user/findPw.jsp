			...
			<div class="container">
				...
				<div class="p-5">
					<div class="text-center">
						<h4 class="text-dark mb-4">비밀번호찾기</h4>
						...
						<div class="card align-middle qwer" style="width: 25rem;">
							...
							<div class="card-body">
								<form id="findId" action="${pageContext.request.contextPath}/findPw" method="post">
									<div class="mb-3">
									<c:if test="${check == 1}">
									...
									<div class="mb-3">
									<c:if test="${check == 0 }">
										<input id="phoneNumber" class="form-control form-control-user" type="text" value="찾으시는 비밀번호는 ${pasword} 입니다." />
										</c:if>
									</div>
