<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
			...
			<div id="aside" class="col-2">
				...
				<ul class="list-group list-group-flush">
					<li class="list-group-item"><a class="fw-bold" href="${pageContext.request.contextPath }/my/my-profile">나의 프로필</a></li>
					...
					<li class="list-group-item"><a class="fw-bold" href="${pageContext.request.contextPath }/my/my-bookmark1">북마크</a></li>
					<li class="list-group-item"><a class="fw-bold" href="${pageContext.request.contextPath }/my/my-review">나의 리뷰</a></li>
