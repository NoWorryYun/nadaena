<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
			...
			<div id="aside" class="col-2">
				...
				<ul class="list-group list-group-flush">
					<li class="list-group-item"><a class="fw-bold" href="${pageContext.request.contextPath }/my/main">나의 정보</a></li>
					<li class="list-group-item"><a class="fw-bold" href="${pageContext.request.contextPath }/my/challenge">나의 챌린지</a></li>
					<li class="list-group-item"><a class="fw-bold" href="${pageContext.request.contextPath }/my/event">나의 이벤트</a></li>
