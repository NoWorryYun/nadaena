						...
						<div id="read-content">
							<div id="read-tab">
								<ul class="nav nav-tabs" role="tablist">
									...
									<li class="nav-item read-tab" role="presentation"><a class="nav-link" role="tab" href="${pageContext.request.contextPath}/challenge/main2">인증하기</a></li>
									<li class="nav-item read-tab" role="presentation"><a class="nav-link active" role="tab" href="${pageContext.request.contextPath}/challenge/main3">커뮤니티</a></li>
