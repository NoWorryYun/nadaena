			...
			<div>
				<div class="board-content-box">
					...
					<div class="border-content">
						<p>
							<span style="color: rgb(32, 33, 36);">난 너를 믿었던만큼 난 내 친구도 믿었기에</span><br>
							<span style="color: rgb(32, 33, 36);">난 아무런 부담없이 널 내 친구에게 소개시켜 줬고</span><br>
							<span style="color: rgb(32, 33, 36);">그런 만남이 있은 후부터 우리는 자주 함께 만나며</span><br>
							<span style="color: rgb(32, 33, 36);">즐거운 시간을 보내며 함께 어울렸던 것뿐인데</span><br>
						</p>
					</div>
				</div>
				<div>
						...
						<table class="table">
							<tbody style="border: none;">
								...
								<tr>
									...
									<td class="board-read-cell">댓글쓰기를 생활화합시다.&nbsp;댓글쓰기를 생활화 합시다.댓글쓰기를 생활화 합시다.댓글쓰기를 생활화 합시다. 댓글쓰기를 생활화 합시다.댓글쓰기를 생활화 합시다.댓글쓰기를 생활화 합시다.댓글쓰기를 생활화 합시다.<br>
									<br></td>
								</tr>
							</tbody>
						</table>
