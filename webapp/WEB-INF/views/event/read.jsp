					...
					<div id="read-main">
						<div id="read-header-box">
							<h2 class="read-header">
								몽쉘 신제품 출시 이벤트<br>2022-08-06~2022-08-27<br>
							</h2>
						...
						<div id="read-content">
							<div id="read-tab">
								<ul class="nav nav-tabs" role="tablist">
									<li class="nav-item read-tab" role="presentation"><a class="nav-link active" role="tab" data-bs-toggle="tab" href="#tab-1">소개글</a></li>
									<li class="nav-item read-tab" role="presentation"><a class="nav-link" role="tab" data-bs-toggle="tab" href="#tab-2">인증하기</a></li>
								...
								<div class="tab-content">
									<div class="tab-pane active" role="tabpanel" id="tab-1">
										...
										<!-- main_intro -->
										<c:import url="/WEB-INF/views/event/intro.jsp"></c:import>
										<!-- /main_intro -->
									...
									<div class="tab-pane" role="tabpanel" id="tab-2">
										...
										<!-- main_certify -->
										<c:import url="/WEB-INF/views/event/certify.jsp"></c:import>
										<!-- /main_certify -->
									...
									<div class="tab-pane" role="tabpanel" id="tab-3">
										...
										<!-- main_community -->
										<c:import url="/WEB-INF/views/event/community.jsp"></c:import>
										<!-- /main_community -->
									...
									<div class="tab-pane" role="tabpanel" id="tab-4">
										...
										<!-- main_review -->
										<c:import url="/WEB-INF/views/event/review.jsp"></c:import>
										<!-- /main_review -->
